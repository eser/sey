...
class runnerOp {
    ...
    startOp(task, value) {
        ...
        return _asyncToGenerator(function* () {
            ...
            yield sey.registry.exec(task, value, _this, modifiedFiles);
        })();
    }
    ...
    start() {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let task in _this2.op) {
                if (task !== 'src' && task !== 'dest' && _this2.op[task] !== false) {
                    yield _this2.startOp(task, _this2.op[task]);
                }
            }

            if (_this2.op.dest !== undefined) {
                _this2.outputFiles(_this2.op.dest);
            }
        })();
    }
