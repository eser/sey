    ...
    exec(value, runnerOpSet, files) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (runnerOpSet.isStandard(2015)) {
                ...
                // v4.0.0 and upper
                options.plugins = options.plugins.concat([require('babel-plugin-transform-es2015-destructuring'), require('babel-plugin-transform-es2015-function-name'), require('babel-plugin-transform-es2015-parameters'), require('babel-plugin-transform-es2015-spread'), require('babel-plugin-transform-es2015-sticky-regex'), require('babel-plugin-transform-es2015-unicode-regex'), require('babel-plugin-transform-es2015-modules-commonjs'), require('babel-plugin-transform-es2015-generator-return')]);
            }
