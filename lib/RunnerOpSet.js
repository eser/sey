...
class RunnerOpSet {
    ...
    isTargeting(target) {
        if (this.bundleConfig.target === undefined && target === 'node' || this.bundleConfig.target === target) {
            return true;
        }
    ...
    isStandard(standard) {
        if (this.bundleConfig.standard === undefined && standard >= 2016 || this.bundleConfig.standard >= standard) {
            return true;
        }
